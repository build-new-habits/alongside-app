...
const ui  = strip(fs.readFileSync(_gatePath("js/views/session-builder-ui.js"), "utf8"));
const sb  = strip(fs.readFileSync(_gatePath("js/session-builder.js"), "utf8"));
const css = fs.readFileSync(_gatePath("css/components/session-shared.css"), "utf8");
