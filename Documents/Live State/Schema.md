...
**File:** `js/store.js` (confirmed live version: v13, 04 Aug 2026)
**Storage:** `localStorage` key `alongside_user`

**This version supersedes:** `schema.md` v1.12 (04 Aug 2026, earlier today). New field `severePainChoices` — the Severe pain Rest/Adapt active-choice record (`coach-proposal.js` v17, `store.js` v13). See field note below.
